...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearController(clearViewModel, clearUserDataAccessObject, viewManagerModel);
    ...
    private static ClearController createClearController(ClearViewModel clearViewModel, ClearUserDataAccessInterface clearUserDataAccessObject, ViewManagerModel viewManagerModel) {
        ClearOutputBoundary clearPresenter = new ClearPresenter(viewManagerModel, clearViewModel);
        ClearInputBoundary clearInteractor = new ClearInteractor(clearUserDataAccessObject, clearPresenter);
